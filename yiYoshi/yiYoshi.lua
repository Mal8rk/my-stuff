...
do
    ...
    local npcTongueBehaviourSpecialCases = {
        ...
        [531] = NPC_TONGUE_BEHAVIOUR.NO_EGG,          -- grroll
        ...
        [433] = NPC_TONGUE_BEHAVIOUR.PASSES_THROUGH, -- crate
...
do
    ...
    yoshi.babyAnimations = {
        ...
        crying = {8,8,8,9,9,9,10,11,10, frameDelay = 8,loopPoint = 4},
    ...
    function findBabyAnimation()
        ...
        elseif data.babyMario.state == BABY_STATE.KIDNAPPED or data.babyMario.state == BABY_STATE.CARRIED_OFF then
            return "idle"
        elseif data.babyMario.state == BABY_STATE.RESCUED then
            return "yeeted"
        end
